...
public class RegistrationFormGUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NbaFantasyCenter.addUser(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jPasswordField1.getText());
        User u = NbaFantasyCenter.getLastUserAdded();
        NbaFantasyCenter.setCurrentUser(u);
        HomeMenuGUI h = new HomeMenuGUI();
        h.setVisible(true);
